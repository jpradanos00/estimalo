        ...
        <div className="border-t border-slate-200 dark:border-slate-700 motion-safe:animate-fade-in">
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    {isCompleted && onViewResult && (
                      <button
                        ...
                        className="text-[11px] font-medium text-indigo-500 dark:text-indigo-400 hover:underline focus-ring flex-shrink-0 min-h-[44px] flex items-center"
                      >
          ...
          {canAdd && !adding && (
            <button
              ...
              className="w-full flex items-center gap-2 px-4 py-2.5 text-xs font-medium text-indigo-500 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors focus-ring min-h-[44px]"
            >
